package com.kubenext.uaa.repository;

import com.kubenext.uaa.UaaApp;
import com.kubenext.uaa.config.Constants;
import com.kubenext.uaa.config.audit.AuditEventConverter;
import com.kubenext.uaa.domain.PersistentAuditEvent;
...
import static com.kubenext.uaa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
